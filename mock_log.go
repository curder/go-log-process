    ...
    */
    ...
    for {
        for i := 1; i < 4; i++ {
            ...
            upstreamResponseTime := rand.Float64()
            requestTime := rand.Float64()

            if path == "/foo" {
                requestTime = requestTime + 1.4
                upstreamResponseTime = upstreamResponseTime + 1.6
            }
